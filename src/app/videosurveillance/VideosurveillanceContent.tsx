...
import { Camera, Monitor, Smartphone, HardDrive, ArrowRight, Phone, Check } from "lucide-react";

const features = [
  {
    icon: Camera,
    title: "Caméras HD",
    description: "Images haute définition jour et nuit. Vision infrarouge pour une surveillance 24h/24.",
  },
  {
    icon: Monitor,
    title: "Monitoring 24/7",
    description: "Surveillance en continu avec enregistrement et alertes en temps réel.",
  },
  {
    icon: Smartphone,
    title: "Accès à distance",
    description: "Visualisez vos caméras depuis votre smartphone, n'importe où dans le monde.",
  },
  {
    icon: HardDrive,
    title: "Stockage sécurisé",
    description: "Enregistrement local ou cloud. Vos données restent protégées et accessibles.",
  },
];
...
const products = [
  {
    title: "Résidentiel",
    description: "Systèmes de surveillance discrets et efficaces pour votre maison.",
    items: ["Caméras extérieures HD", "Détection de mouvement", "Notification smartphone", "Enregistrement 7 jours"],
  },
  {
    title: "Commercial",
    description: "Solutions professionnelles pour bureaux, commerces et entrepôts.",
    items: ["Caméras 4K professionnelles", "NVR multi-canaux", "Monitoring centralisé", "Accès multi-utilisateurs"],
  },
  {
    title: "Immeubles",
    description: "Surveillance complète pour résidences et copropriétés.",
    items: ["Couverture complète", "Gestion par syndic", "Interfaçage vidéophonie", "Rapports automatiques"],
  },
];
    ...
    <>
      <section className="relative min-h-[70vh] flex items-center bg-charcoal overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-24 pb-16" ref={heroRef}>
          ...
          >
            Gardez un œil sur <span className="text-brand">tout</span>
          </h1>
          <p
            data-animate="fade-up-lg"
            className="text-lg md:text-xl text-white/60 max-w-xl mb-8 leading-relaxed"
          >
            Caméras HD, monitoring 24/7 et accès à distance. Votre propriété sous surveillance, même à distance.
          </p>
        ...
        <div className="container mx-auto px-6" ref={featRef}>
          <div className="text-center mb-16">
            ...
            <h2 data-animate className="font-display text-5xl md:text-6xl text-foreground mb-4">
              Surveillance <span className="text-brand">intelligente</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-background">
        <div className="container mx-auto px-6" ref={prodRef}>
          <div className="text-center mb-16">
            ...
            <h2 data-animate className="font-display text-5xl md:text-6xl text-foreground mb-4">
              Pour chaque <span className="text-brand">besoin</span>
            </h2>
          </div>
